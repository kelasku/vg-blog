...
const privacyPolicy = () => (
  <>
    <Head>
      ...
      <meta key="keywords" name="keywords" content={`${DEFAULT_SEO.keywords}, privacy policy`} />
    </Head>
    ...
    <div className="wrapper">
      ...
      <p>
        Valentin Gurkov's Blog ("us", "we", or "our") operates the http://www.vgblog.com website (hereinafter referred
        to as the "Service").
      </p>
      ...
      <p>
        We use cookies and similar tracking technologies to track the activity our Service and hold certain information.
      </p>
      <p>
      ...
      <p>
        ...
        cookies in the{' '}
        <a title="Browser Cookies Guide" href="https://privacypolicies.com/blog/how-to-delete-cookies/">
      ...
      <ul>
        <li>
          <strong>Session Cookies.</strong> We use Session Cookies to operate Service.
        </li>
        <li>
        ...
        <li>
          <strong>Security Cookies.</strong> We use Security Cookies for purposes.
        </li>
      </ul>

      <h2>Use of Data</h2>

      <p>Valentin Gurkov's Blog uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Bulgaria and choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Bulgaria and process it there.
      </p>
      <p>
      ...
      <p>
        Valentin Gurkov's Blog will take all steps reasonably necessary to that your data is treated securely and in
      ...
      <p>
        Valentin Gurkov's Blog may disclose your Personal Data in the good faith belief that such action is necessary
        to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Valentin Gurkov's Blog</li>
      ...
      <p>
        The security of your data is important to us, but remember that no of transmission over the Internet, or method
      ...
      <h3>Analytics</h3>
      <p>We may use third-party Service Providers to monitor and analyze the use our Service.</p>
      <ul>
        <li>
          <p>
          ...
          <p>
            You can opt-out of having made your activity on the Service to Google Analytics by installing the Google
          ...
          <p>
            ...
            <a title="Google privacy practices" href="https://policies.google.com/privacy?hl=en">
      ...
      <p>
        We may update our Privacy Policy from time to time. We will notify you any changes by posting the new Privacy
        Policy on this page.
      </p>
      <p>
      ...
      <ul>
        <li>By email: contact@vgblog.com</li>
        <li>By visiting this page on our website: http://www.vgblog.com/contact-us</li>
